package com.navgurkul.scratch.ui
...
import com.navgurkul.scratch.R
...
//            WindowManager.LayoutParams.FLAG_FULLSCREEN)
    ...
    private fun showCodeSaveDialog() {
        val view: View = layoutInflater.inflate(org.merakilearn.R.layout.alert_save, null)
        val alertDialog = AlertDialog.Builder(this).apply {
            setTitle("Save Scratch File")
            setIcon(org.merakilearn.R.drawable.ic_scratch)
            setCancelable(false)
            setMessage("You may loose your progress if you exit without saving")
        }

        val fileName: EditText = view.findViewById(org.merakilearn.R.id.fileName)
        file?.let {
